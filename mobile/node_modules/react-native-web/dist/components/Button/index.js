...
}}]);return Button;}(_react.Component);process.env.NODE_ENV!=="production"?Button.propTypes={accessibilityLabel:_react.PropTypes.string,color:_ColorPropType2.default,disabled:_react.PropTypes.bool,onPress:_react.PropTypes.func.isRequired,testID:_react.PropTypes.string,title:_react.PropTypes.string.isRequired}:void 0;
